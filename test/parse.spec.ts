...
describe('parse()', function() {
  ...
  it('should parse valid document', async function() {
    ...
    const { document, diagnostics } = await parse(parser, asyncapiDocument);
  ...
  it('should preserve references', async function() {
    ...
    const { document } = await parse(parser, asyncapiDocument);
  ...
  it('should parse circular references (in external file)', async function() {
    ...
    const { document } = await parse(parser, asyncapiDocument, { source: __filename });
