const { createMapOfType, getMapValueOfType, getMapValueByKey, isNotEmptyObject, isNotEmptyArray, addExtensions } = require('../utils');
...
class Server extends Base {
   ...
   */
  hasVariables() {
    return isNotEmptyObject(this._json.variables);
  }
   ...
   */
  hasSecurity() {
    return isNotEmptyArray(this._json.security);
  }
