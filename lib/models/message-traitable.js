const { getMapValueOfType, getMapValueByKey, mix } = require('../utils');
...
module.exports = mix(MessageTraitable, MixinDescription, MixinExternalDocs, MixinTags, MixinBindings, MixinSpecificationExtensions);
